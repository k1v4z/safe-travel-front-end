    ...
    <div className="min-h-screen bg-[#5fb6aa40] flex items-center justify-center">
      <div className="bg-white w-[450px] flex flex-col items-center rounded-lg relative p-6">
        <Image
          ...
          height={100}
        />
        <button className="absolute top-3 right-3 text-gray-400 font-bold">
          X
        </button>
        <div className="mt-10 mb-4">
          <Image
            className="w-10 rounded-full"
            src="/pictures/meo2.webp"
            alt="profile"
            width={30}
            height={30}
          />
        ...
        <button
          className="w-full bg-gray-600 text-white rounded-xl py-3 hover:bg-gray-800"
          onClick={handleLogin}
        >
          Login
        </button>
