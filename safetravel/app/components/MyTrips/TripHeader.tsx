...
const TripHeader = () => {
  ...
  const handleClickBuilderTrip = (isAI: boolean) => {
    setPlan({...plan, isAITrip: isAI})
  }
    ...
    <div>
      <header className="mb-8">
        ...
        <div className="flex justify-center gap-4 mb-4">
          <Link href='/planning' onClick={() => {handleClickBuilderTrip(false)}} className='w-auto px-8 py-4 flex flex-grow items-center justify-center bg-green-100 rounded-lg text-lg hover:bg-green-200 transition-colors'>
          ...
          <Link href={"/planning"} onClick={() => {handleClickBuilderTrip(true)}} className="w-auto px-8 py-4 flex flex-grow items-center justify-center bg-blue-100 rounded-lg text-lg hover:bg-blue-200 transition-colors">
            <button className="w-auto px-8 py-4 flex flex-grow items-center justify-center bg-blue-100 rounded-lg text-lg hover:bg-blue-200 transition-colors">
              <Image
                ...
                className="mr-2"
              />
              <div className="font-gideonroman font-bold">
